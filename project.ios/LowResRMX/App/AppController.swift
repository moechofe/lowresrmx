...
@objc class AppController: NSObject
{
	...
	var hasDontated: Bool
	{
		get
		{
			UserDefaults.standard.bool(forKey: AppController.hasDontatedKey)
		}
		set
		{
	...
	var isSafeScaleEnabled: Bool
	{
		get
		{
			UserDefaults.standard.bool(forKey: AppController.isSafeScaleEnabledKey)
		}
		set
		{
	...
	var forcesSmallGamepad: Bool
	{
		get
		{
			UserDefaults.standard.bool(forKey: AppController.forcesSmallGamepadKey)
		}
		set
		{
	...
	var numRunProgramsThisVersion: Int
	{
		get
		{
			UserDefaults.standard.integer(forKey: AppController.numRunProgramsThisVersionKey)
		}
		set
		{
	...
	private(set) var userId: String?
	{
		get
		{
			UserDefaults.standard.string(forKey: AppController.userIdKey)
		}
		set
		{
	...
	private(set) var username: String?
	{
		get
		{
			UserDefaults.standard.string(forKey: AppController.usernameKey)
		}
		set
		{
