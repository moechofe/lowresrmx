...
class ProjectManager: NSObject {
    ...
    func importProgram(from url: URL, completion: @escaping ((Error?) -> Void)) {
        ...
        let destUrl = self.currentDocumentsUrl.appendingPathComponent(name).appendingPathExtension("rmx")
    ...
    func addProject(originalName: String, programData: Data?, imageData: Data?, completion: @escaping ((Error?) -> Void)) {
        ...
        let programUrl = self.currentDocumentsUrl.appendingPathComponent(name).appendingPathExtension("rmx")
    ...
    func duplicateProject(item: ExplorerItem, completion: @escaping (Error?) -> Void) {
        ...
        let programDestUrl = self.currentDocumentsUrl.appendingPathComponent(newName).appendingPathExtension("rmx")
