...
@objc enum LabelIndexMode: Int, CaseIterable
{
	...
	var title: String
	{
		switch self
		{
		case .noLabels: "No Labels"
		case .allLabels: "All Labels"
		case .labelsWithoutUnderscore: "Labels w/o '_'"
		}
	}
}
...
@objc enum ProcedureIndexMode: Int, CaseIterable
{
	...
	var title: String
	{
		switch self
		{
		case .noProcedures: "No Subs"
		case .allProcedures: "All Subs"
		}
	}
}
...
@objc enum MarkerIndexMode: Int, CaseIterable
{
	...
	var title: String
	{
		...
		case .manualMarkers: "Manual Markers"
		}
	}
}
